...
// Eigenständige Farb-/Formsprache fürs Veranstalterportal (Indigo #2D2A6E
// als einzige Akzentfarbe, durchgehend rounded-full) — bewusst NICHT das
// Apple-Blau/Pill-Schema des internen Redaktions-Dashboards. Literale
