...
export default async function EditPersonPage({
  ...
  const [{ data, error }, { data: ensembles }] = await Promise.all([
    supabase
      .from("persons")
      .select(
        "slug, full_name, first_name, middle_name, last_name, roles, instrument, nationality, birth_date, death_date, is_deceased, biography_de, website_url, social_links, photo_url, avatar_crop_x, avatar_crop_y, avatar_crop_width, avatar_crop_height, member_of_ensemble_id, is_verified",
      )
      .eq("id", id)
