...
Deno.serve(async (req) => {
  ...
  // Generated by Claude Code — Sicherheitslücke geschlossen: diese Function
  // ist ein Admin-Werkzeug (Besetzungs-Erkennung beim Event-Editieren) und
  // löst kostenpflichtige KI-Aufrufe aus, hatte bisher aber außer dem
  // Standard-verify_jwt keine eigene Berechtigungsprüfung — jede angemeldete
  // ODER anonyme Session (enable_anonymous_sign_ins ist aktiv) konnte sie
  // beliebig oft aufrufen. Gleiches Muster wie alle anderen privilegierten
  // Functions, siehe _shared/internalAuth.ts.
