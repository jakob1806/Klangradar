...
final class CityStore: ObservableObject {
    ...
    func select(_ city: RegionOption?) {
        // Generated by Claude Code — Stadtwechsel ist hier eine einzelne
        // Antippen-und-bestätigt-Aktion (kein separater Bestätigen-Schritt
        // wie im Onboarding), daher direkt der Bestätigungs-Impuls.
        if city != nil { Haptics.confirm() }
        selectedCity = city
