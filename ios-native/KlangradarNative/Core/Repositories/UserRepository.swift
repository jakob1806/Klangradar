...
final class FavoriteStore: ObservableObject {
    ...
    func toggle(_ eventID: UUID) async {
        ...
        // Generated by Claude Code — zentral hier, damit jeder Herz-/
        // Lesezeichen-Button (Home, Suche, Kalender, Detailseiten) dasselbe
        // Feedback gibt: Bestätigung beim Speichern, weicher beim Entfernen.
        newValue ? Haptics.confirm() : Haptics.soft()
...
final class FollowStore: ObservableObject {
    ...
    func toggle(kind: EntityKind, id: UUID) async {
        ...
        // Generated by Claude Code — zentral hier statt an jeder Aufrufstelle
        // (Detailseiten, Onboarding-Folgen-Schritt, Profil-Interessen):
        // klarer Erfolgs-Impuls beim Folgen, weicherer beim Entfolgen.
        newValue ? Haptics.confirm() : Haptics.soft()
        do {
