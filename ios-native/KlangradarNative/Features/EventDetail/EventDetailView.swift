                ...
                .overlay(alignment: .top) {
                    HStack(spacing: 10) {
                        ...
                        if let icsURL = calendarExportURL() {
                            // Generated by Claude Code — ShareLink liefert
                            // kein Erfolgs-Callback für die eigentliche
                            // Kalender-Übernahme (das System-Sheet läuft
                            // außerhalb unserer Kontrolle), daher hier nur
                            // ein leichter Tipp-Impuls beim Öffnen statt des
                            // "deutlichen" Erfolgs-Impulses aus der
                            // Haptik-Vorgabe.
