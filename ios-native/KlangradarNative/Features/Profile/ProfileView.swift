        ...
        NavigationStack {
            Form {
                ...
                Section("Über Klangradar") {
                    // Generated by Claude Code — der externe Link zeigte auf
                    // die falsche Domain (klangradar.app statt .com) und
                    // lief damit ins Leere; jetzt wie Impressum als
                    // In-App-Ansicht.
                    NavigationLink {
                        AGBView()
                    } label: {
            ...
            .fullScreenCover(isPresented: $showsLogin) {
                ...
                // Generated by Claude Code — siehe RootTabView: ohne
                // explizites Reattach stürzt FollowCategoryStepView hier ab.
...
private struct MyKlangradarHubView: View {
    ...
    var body: some View {
        ...
        // Nutzerfeedback: Kacheln hatten dieselbe Farbe wie der Hintergrund
        // (kein Kontrast sichtbar) -- gleiches Design wie Profil -> Level ->
        // "Meine Klangreise" (LevelDetailView): expliziter
        // .systemGroupedBackground-Seitenhintergrund, Kacheln in
        // .background (Systemvordergrund/Weiß) statt
        // .secondarySystemGroupedBackground (das dort fast identisch zum
        // Standard-Gruppenhintergrund aussieht).
        .background(Color(uiColor: .systemGroupedBackground))
        .navigationTitle("Mein Klangradar")
        .task { await load() }
    }
